...
namespace Nop.Plugin.Affiliate.Amazon.Core
{
    public class SignedRequestHelper
    {
        ...
        protected const string REQUEST_URI = "/onca/xml";
        protected const string REQUEST_METHOD = "GET";
         ...
         */
        protected string PercentEncodeRfc3986(string str)
        {
         ...
         */
        protected IDictionary<string, string> CreateDictionary(string queryString)
        {
         ...
         */
        protected string ConstructCanonicalQueryString(SortedDictionary<string, string> sortedParamMap)
        {
            StringBuilder builder = new StringBuilder();
