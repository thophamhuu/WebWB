...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual ActionResult Shipping()
        {
            ...
            ViewBag.IsAdditionalCost = _settingService.GetSettingByKey<bool>("worldbuy.settings.shipping.isadditionalcost", false);
            ViewBag.AdditionalCost = _settingService.GetSettingByKey<decimal>("worldbuy.settings.shipping.additionalcost", 0);
        ...
        public virtual ActionResult Shipping(ShippingSettingsModel model)
        {
            ...
            bool isAdditionalCost = false;
            isAdditionalCost = Request.Form["IsAdditionalCost"].ToString().Contains("true");
            _settingService.SetSetting<bool>("worldbuy.settings.shipping.isadditionalcost", isAdditionalCost);
            decimal additionalCost = 0;
            Decimal.TryParse(Request.Form["AdditionalCost"].ToString(), out additionalCost);
            _settingService.SetSetting<decimal>("worldbuy.settings.shipping.AdditionalCost", additionalCost);
