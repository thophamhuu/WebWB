...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual ActionResult SetLanguage(int langid, string returnUrl = "")
        {
            ...
            //var currencyModel = _commonModelFactory.PrepareCurrencySelectorModel();
            //foreach (var curr in currencyModel.AvailableCurrencies)
            //{
            //    var currency = _currencyService.GetCurrencyById(curr.Id);
            //    if (currency.DisplayLocale == language.LanguageCulture)
            //    {
            //        return RedirectToAction("SetCurrency", new { returnUrl = returnUrl, customerCurrency = currency.Id });
            //    }
            //}
