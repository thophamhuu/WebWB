(function ($, ss) {
    ...
    function handleReponsiveHeaderLinks() {
        ...
        $(document).on('themeBreakpointPassed7Spikes', function (e) {
            ...
            if (e.isMobileResolution) {
                ...
                languageSelector.detach().appendTo('.responsive-nav-wrapper #language-selector-opener');
                pageTitle.detach();
                ...
                if (e.isInitialLoad === false) {
                    // desktop
                    searchBox.detach().appendTo('.header-middle .center .worldbuy-header-search');
                    ...
                    shoppingCart.detach().appendTo('.header-middle .center .worldbuy-header-cart');
                    languageSelector.detach().appendTo('.header-upper .center .worldbuy-header-language');
        ...
        responsiveHeaderLinkOpeners.on('click', function () {
            ...
            if (nextElement.is(':visible')) {
                ...
                $('.responsive-nav-wrapper-parent').css('z-index', '1070');
    ...
    function handleHeaderMenuCategories() {
        ...
        if ($('.two-columns-area.slider-right-column').length > 0) {
            ...
            //});
            $('.category-navigation-title').mouseover(function () {
                sideCategoriesList.slideDown();
            });
            $(".category-navigation-list-wrapper").mouseleave(function () {
                sideCategoriesList.slideUp();
            });
            //$('.category-navigation-title').on('mouseout', function () {
            //    sideCategoriesList.slideToggle();
            //});
        }
    }
